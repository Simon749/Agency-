...
export default function Hero() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // TODO: Wire up to tRPC mutation when reservation router is built
    setSubmitted(true)
  }
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            PROPFLOW &middot; Access &amp; Enquiries
          </p>
        </div>
      </div>
      ...
      >
        <div style={{ maxWidth: '520px', width: '100%', marginLeft: 'auto', marginRight: 'auto' }}>
          ...
          {submitted ? (
            ...
            >
              Thank you &mdash; we'll review your enquiry and reach out within 24
            ...
            >
              ...
              <Row>
                <Field label="Agency Name" type="text" name="checkin" value={formData.checkin} onChange={handleChange} />
                <Field label="Location / Area" type="text" name="checkout" value={formData.checkout} onChange={handleChange} />
              </Row>
              <Row>
                <Field label="No. of Properties" type="number" name="guests" placeholder="e.g. 12" min={1} value={formData.guests} onChange={handleChange} />
                <SelectField
              ...
              <TextareaField
                ...
                name="message"
                placeholder="Tell us more about your setup — number of tenants, current tools, specific needs&hellip;"
