  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Kenya's Property Management Platform · Est. 2024
        </span>
        ...
        >
          PropFlow is an invite-only platform built for Kenyan property agencies.
          Manage buildings, collect rent via M-Pesa, track utilities, and keep
          tenants informed — all from one place.
        </p>
